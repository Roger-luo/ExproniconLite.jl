...
#= /home/roger/code/julia/Expronicon/src/expand.jl:108 =# @static if !(isdefined(#= /home/roger/code/julia/Expronicon/src/expand.jl:108 =# @__MODULE__(), :include_generated))
        function _include_generated(_path::String)
            #= /home/roger/code/julia/Expronicon/src/expand.jl:110 =# Base.@_noinline_meta
            mod = #= /home/roger/code/julia/Expronicon/src/expand.jl:111 =# @__MODULE__()
...
#= /home/roger/code/julia/Expronicon/src/expand.jl:135 =# @static if VERSION < v"1.3"
        macro var_str(x)
            Symbol(x)
        end
    end
