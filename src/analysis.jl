    ...
    #= none:95 =# Core.@doc "    compare_expr(lhs, rhs)\n\nCompare two expression of type `Expr` or `Symbol` semantically, which:\n\n1. ignore the detail value `LineNumberNode` in comparision\n2. ignore the detailed name of typevars in `Expr(:curly, ...)` or `Expr(:where, ...)`\n\nThis gives a way to compare two Julia expression semantically which means\nalthough some details of the expression is different but they should\nproduce the same lowered code.\n" function compare_expr(lhs, rhs)
            ...
            if x_1 isa Tuple{Expr, Expr}
                if begin
                    ...
                    $(Expr(:symbolicgoto, Symbol("##final#276_1")))
                end
                if begin
                            cache_3 = nothing
                            x_12 = x_1[1]
            ...
            $(Expr(:symboliclabel, Symbol("##final#276_1")))
            return_1
        end
    #= none:127 =# Core.@doc "    compare_vars(lhs, rhs)\n\nCompare two expression by assuming all `Symbol`s are variables,\nthus their value doesn't matter, only where they are matters under\nthis assumption. See also [`compare_expr`](@ref).\n" function compare_vars(lhs, rhs)
            ...
            if x_36 isa Tuple{Expr, Expr}
                if begin
                    ...
                    $(Expr(:symbolicgoto, Symbol("##final#320_1")))
                end
            end
            ...
            $(Expr(:symboliclabel, Symbol("##final#320_1")))
            return_2
        end
            ...
            let
                ...
                if x_51 isa Expr
                    if begin
                        ...
                        $(Expr(:symbolicgoto, Symbol("##final#340_1")))
                    end
                    if begin
                                x_54 = cache_9.value
                ...
                $(Expr(:symboliclabel, Symbol("##final#340_1")))
                return_3
            end
        end
            ...
            let
                ...
                if x_58 isa Expr
                    if begin
                        ...
                        $(Expr(:symbolicgoto, Symbol("##final#351_1")))
                    end
                    if begin
                                x_64 = cache_10.value
                ...
                $(Expr(:symboliclabel, Symbol("##final#351_1")))
                return_4
            end
        end
    ...
    #= none:347 =# Core.@doc "    is_field(ex)\n\nCheck if `ex` is a valid field expression.\n" function is_field(#= none:352 =# @nospecialize(ex))
            let
                ...
                if x_72 isa Symbol
                    ...
                    $(Expr(:symbolicgoto, Symbol("##final#371_1")))
                end
                if x_72 isa Expr
                    if begin
                                if cache_13 === nothing
                ...
                $(Expr(:symboliclabel, Symbol("##final#371_1")))
                return_5
            end
        end
            ...
            let
                ...
                if x_115 isa Expr
                    if begin
                        ...
                        $(Expr(:symbolicgoto, Symbol("##final#429_1")))
                    end
                    if begin
                ...
                $(Expr(:symboliclabel, Symbol("##final#429_1")))
                return_8
            end
        end
            ...
            let
                ...
                if x_128 isa Expr
                    if begin
                        ...
                        $(Expr(:symbolicgoto, Symbol("##final#446_1")))
                    end
                    if begin
                ...
                $(Expr(:symboliclabel, Symbol("##final#446_1")))
                return_9
            end
        end
    #= none:468 =# Core.@doc "    split_struct_name(ex::Expr) -> name, typevars, supertype\n\nSplit the name, type parameters and supertype definition from `struct`\ndeclaration head.\n" function split_struct_name(#= none:474 =# @nospecialize(ex))
            return let
                    ...
                    if x_173 isa Symbol
                        ...
                        $(Expr(:symbolicgoto, Symbol("##final#498_1")))
                    end
                    if x_173 isa Expr
                        if begin
                                    if cache_24 === nothing
                    ...
                    $(Expr(:symboliclabel, Symbol("##final#498_1")))
                    return_10
                end
        end
    ...
    #= none:583 =# Core.@doc "    JLStruct(ex::Expr)\n\nCreate a `JLStruct` object from a Julia struct `Expr`.\n\n# Example\n\n```julia\njulia> JLStruct(:(struct Foo\n           x::Int\n       end))\nstruct Foo\n    #= REPL[38]:2 =#\n    x::Int\nend\n```\n" function JLStruct(ex::Expr)
            ...
            for each = body.args
                ...
                if x_190 isa Symbol
                    ...
                    $(Expr(:symbolicgoto, Symbol("##final#520_1")))
                end
                if x_190 isa Expr
                    if begin
                                if cache_26 === nothing
                ...
                $(Expr(:symboliclabel, Symbol("##final#520_1")))
                return_11
            end
