    ...
    function print_expr(io::IO, ex, ps::PrintState, theme::Color)
        ...
        if x_1 isa Expr
            if begin
                ...
                $(Expr(:symbolicgoto, Symbol("##final#551_1")))
            end
            if begin
                        x_6 = cache_1.value
            ...
            if begin
                        ...
                        x_51 isa Tuple{Symbol, var2} where var2<:AbstractArray
                                ...
                                x_52 isa AbstractArray
                                        ...
                                        x_53 = x_52[1]
                                        if cache_2 === nothing
                                            cache_2 = Some(((Val{(view, Symbol("##Symbol(x)#276"))}())())(x_53))
                                        end
        ...
        $(Expr(:symboliclabel, Symbol("##final#551_1")))
        return_1
    end
    ...
    function print_within_line(io::IO, ex, ps::PrintState, theme::Color = Color())
        within_line(io, ps) do 
            ...
            if x_91 isa Number
                ...
                $(Expr(:symbolicgoto, Symbol("##final#646_1")))
            end
                    ...
                    return_2 = begin
                            ...
                            let
                                ...
                                if x_187 isa Expr && (begin
                                    ...
                                    $(Expr(:symbolicgoto, Symbol("##final#756_1")))
                                end
                                return_3 = let
                                        print_expr(io, x, ps, theme)
                                    end
                                ...
                                $(Expr(:symboliclabel, Symbol("##final#756_1")))
                                return_3
                            end
                        end
                    $(Expr(:symbolicgoto, Symbol("##final#646_1")))
            ...
            $(Expr(:symboliclabel, Symbol("##final#646_1")))
            return_2
        end
        return
    end
